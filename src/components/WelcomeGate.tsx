  ...
  return (
    ...
    >
      ...
      <div className="welcome-content">
        {/* sr-only page heading: gives crawlers and screen readers a real,
            keyword-bearing <h1> without altering the visual logo lockup. */}
        <h1
          style={{
            position: 'absolute',
            width: 1,
        ...
        >
          Space Haven Production & Industry Calculator
        </h1>
